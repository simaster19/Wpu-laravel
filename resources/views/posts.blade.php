        ...
        <div class="card mb-3">
            @if ($posts[0]->image)
                <div style="max-height: 350px; overflow:hidden">
                    ...
                    <img src="{{ asset('storage/' . $posts[0]->image) }}" class="card-img-top mb-3"
                ...
                <p>
                    <small>
                        By <a href="/posts?author={{ $posts[0]->author->username }}"
                            ...
                            href="/posts?category={{ $posts[0]->category->slug }}" class="text-decoration-none text-dark">
                ...
                @foreach ($posts->skip(1) as $post)
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            @if ($post->image)
                                <img src="{{ asset('storage/' . $post->image) }}" class="card-img-top mb-3"
